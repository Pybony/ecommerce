...
class KafkaService<T> implements Closeable {
    ...
    private KafkaService(String groupId, ConsumerFunction parse, Class<T> type, Map<String, String> properties) {
        this.parse = parse;
        this.consumer = new KafkaConsumer<String, T>(getPorperties(type, groupId, properties));
    }
    ...
    private Properties getPorperties(Class<T> type, String groupId, Map<String, String> overrideProperties) {
